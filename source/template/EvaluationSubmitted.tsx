...
type EvaluationSubmittedProps = Record<'teamUrl', string>;
...
export const renderEvaluationSubmitted = async ({
    teamUrl
}: Record<'teamUrl', string>): Promise<{ subject: string; html: string }> => ({
    subject: i18n.t('evaluation_submitted_subject'),
    html: await render(<EvaluationSubmitted teamUrl={teamUrl} />)
});
